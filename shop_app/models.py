...
class Cart(models.Model):
    ...
    creted_on = models.DateTimeField(auto_now_add = True , blank = True , null = True)
    updtaed_on = models.DateTimeField(auto_now = True , blank = True ,null = True)
...
class Cart_item(models.Model):
    ...
    def __str__(self):
        return f"{self.quantity} x {self.product.name} in the cart {self.cart_id}"
